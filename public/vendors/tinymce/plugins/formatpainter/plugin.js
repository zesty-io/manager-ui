...
!(function(l) {
  ...
  var e,
    ...
    h = function(e, r, n) {
      return { major: e, minor: r, patch: n };
    },
    b = function(e) {
      ...
      return function(e) {
        return (
          (function(e) {
            ...
            var r = typeof e;
            return "object" === r && Array.prototype.isPrototypeOf(e)
              ? "array"
              : "object" === r && String.prototype.isPrototypeOf(e)
              ? "string"
              : r;
          })(e) === r
        );
    ...
    U = function(e, r) {
      for (var n = 0, t = e.length; n < t; n++) {
        var o = e[n];
        if (r(o, n, e)) return _.some(o);
      }
      return _.none();
    },
    V = function(e, r) {
      for (var n = 0, t = e.length; n < t; n++)
        if (r(e[n], n, e)) return _.some(n);
      return _.none();
    },
    q = function(e, r) {
      for (var n = 0, t = e.length; n < t; ++n) if (e[n] === r) return n;
      return -1;
    },
    ...
    H = (Array.prototype.slice, R(Array.from) && Array.from, Object.keys),
    ...
    se = function(e, r) {
      ...
      ie(e) ? e.dom().classList.remove(r) : ce(e, r),
        0 === (ie((n = e)) ? n.dom().classList : ae(n)).length &&
          te(n, "class");
    },
    fe = function(e) {
    ...
    me = function(e, r) {
      e.fire("FormatPainterToggle", { state: r });
    };
  ...
  var de,
    ...
    be = function(e, r) {
      r.get() === m.Application
        ...
        : (function(r, n) {
            ...
            var e = function() {
                n.get() === m.Application &&
                  (r.execCommand("mcePaintFormats"), he(r, n)),
                  o();
              },
              t = function(e) {
                27 === e.keyCode && (he(r, n), o());
              };
            r.on("click", e), r.on("keydown", t);
            var o = function() {
              r.off("click", e), r.off("keydown", t);
            };
          })(e, r);
    },
    ye =
    ...
    Le = {
      unknown: function() {
        return Ce({ current: void 0, version: Oe.unknown() });
      },
      nu: Ce,
      windows: O(Ee),
      ios: O("iOS"),
    ...
    qe = function(e) {
      var r,
        ...
        m = Ve.browsers(),
        d = Ve.oses(),
        v = Pe(m, e).fold(xe.unknown, xe.nu),
        p = Fe(d, e).fold(Le.unknown, Le.nu);
      return {
        browser: v,
        os: p,
        deviceType:
    ...
    Xe =
      ...
      function() {
        ...
        return pe || ((pe = !0), (ve = de.apply(null, e))), ve;
      }),
    ze = J,
    He =
      (Xe().browser.isIE(),
    ...
    Ke = function(t, e) {
      return j(t.formatter.get(e), function(e) {
        return (r = t), Z((n = e), "inline") && !$e(r, n);
        var r, n;
      });
    },
    Ze = function(t, e, r) {
      return j(e.get(r), function(e) {
        return (r = t), Z((n = e), "block") || $e(r, n);
        var r, n;
      });
    },
    Je = function(e) {
    ...
    Qe = function(e, r) {
      return j(e.formatter.get(r), function(e) {
        return (
          (n = K((r = e), "styles").exists(function(e) {
            return j($(e), Je);
          })),
    ...
    nr = function(e, r, n) {
      ...
      ((r.table && u) || (r.inline && i) || (r.block && a && !u)) &&
        o.apply(n.formatName, n.substitutedVariables);
    },
    tr = function(e, r) {
      return (function(e, r) {
        ...
        [
          Ye(le.fromDom(e.getStart()), er, r),
          Ye(le.fromDom(e.getEnd()), er, r)
        ],
        function(e, r) {
          return (n = r), e.dom() === n.dom();
          var n;
        }
      ).getOr(!1);
    },
    ...
    ir = function(t, e) {
      ...
      (r = t),
        ...
        n === v.Table &&
          (function(e, r) {
            for (var n = 0, t = e.length; n < t; n++) r(e[n], n, e);
          })(
            [
              "formatpainter_borderstyle",
              "formatpainter_bordercolor",
      ...
      var o,
        ...
        f =
          ...
          (s = !!o.dom.getParent(a, "TABLE")),
          {
            ...
            table: (u && s) || c,
            block:
              u || ((i = o.selection), 1 < i.getSelectedBlocks().length) || c
          });
      e.schemas.forEach(function(e) {
        switch (e.kind) {
          case d.ListSchema:
            (r = t), (n = e), f.block && r.execCommand(n.command);
            break;
    ...
    ar = function(e) {
      return ie(e)
        ? (function(e) {
            for (
              var r = e.dom().classList, n = new Array(r.length), t = 0;
              t < r.length;
              t++
            )
              n[t] = r.item(t);
    ...
    ur = function(e, r) {
      var n,
        ...
        a =
          "" !== i ||
          (null != (t = ee((n = e)) ? n.dom().parentNode : n.dom()) &&
    ...
    dr = function(e, r, n) {
      return ((t = e.get(r)), 0 === t.length ? _.none() : _.some(t[0]))
        .bind(function(e) {
          return mr(e, n);
        })
        .map(function(e) {
    ...
    pr = function(e) {
      ...
      U($(c), function(e) {
        ...
        return { kind: d.ListSchema, command: e };
      });
      var r;
    },
    gr = function(e) {
      ...
      return {
        ...
        context:
          ((r = a), (n = u), r.getParent(n, "TABLE") ? v.Table : v.Unspecified)
      };
    },
    hr = function(e) {
      if (S(tinymce, "4.9.0"))
        return (
          l.window.console.error(
            "The format painter plugin requires at least version 4.9.0 of TinyMCE."
          ),
          {}
        );
      var n,
        ...
        c,
        s = p(m.Retrival),
        f = p({ schemas: [], context: v.Unspecified });
      return (
        (n = e).on("PreInit", function() {
          Y(Ge, function(e, r) {
