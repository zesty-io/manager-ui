      ...
      <aside className={styles.GlobalSidebar}>
        <div className={styles.topMenu}>
          ...
          <GlobalMenu
            ...
            products={this.props.site.settings.products}
          />
          <GlobalActions />
        </div>
        <div
          className={cx(styles.subMenu, this.props.ui.globalSubMenu.location)}
        >
          {/*
        ...
        <GlobalAccountMenu
          dispatch={this.props.dispatch}
          accountsMenuVisible={this.props.accountsMenuVisible}
        />
      </aside>
    );
  }
