...
export type RedirectContentItemModalProps = {
  open: boolean;
  onClose: () => void;
...
export const RedirectContentItemModal: FC<RedirectContentItemModalProps> = ({
  open,
  onClose,
  redirect,
  newPath,
...
export default RedirectContentItemModal;
