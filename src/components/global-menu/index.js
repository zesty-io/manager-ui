...
class GlobalMenu extends Component {
  ...
  render() {
    return (
      <section className={styles.GlobalMenu}>
          ...
          <menu>
            ...
            <a href="/audit-trail">
              ...
              <span className={styles.title}>AuditTrail&trade;</span>
            </a>
            <a href="/settings">
          ...
          <div className={styles.GlobalMenuActions}>
...
export default connect(state => state)(GlobalMenu)
